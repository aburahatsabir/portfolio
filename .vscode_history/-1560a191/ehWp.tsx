    ...
    <div className="bg-white min-h-screen pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
            ...
            >
              <div className="grid md:grid-cols-[120px_1fr] gap-8 items-start">
                ...
                <div className="space-y-6">
                   <div>
                     <SectionLabel as="h3" tracking="normal" className="mb-2">{category.subtitle}</SectionLabel>
        ...
        <div className="space-y-12">
           <div>
              <SectionLabel as="h2" tracking="wide" className="mb-6">User Autonomy</SectionLabel>
