            ...
            >
              <div className="flex items-center justify-between mb-12">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <SectionLabel tracking="normal">Institutional Wiki</SectionLabel>
            ...
            >
              <div className="flex items-center justify-between mb-12">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <SectionLabel tracking="wider" color="blue-500">Logic Mapping</SectionLabel>
             ...
             <div className="space-y-8">
                <div className="flex flex-col lg:flex-row items-center gap-6">
                   ...
                   <div>
                     ...
                     <SectionLabel as="p" tracking="tight" className="mt-1">Institutional Stability Commitment</SectionLabel>
                   </div>
                </div>
