...
const ReliabilityCard: React.FC<{ principle: Principle; index: number }> = ({ principle, index }) => {
  return (
    ...
    >
      <BentoCard rounded="2xl" padding="lg" hoverShadow="md" className="hover:shadow-[0_30px_60px_-15px_rgba(15,23,42,0.05)]">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-16 mb-24">
          <div className="max-w-4xl w-full space-y-8">
            <div className="flex items-center gap-4">
              <SectionLabel tracking="wide">Reliability Protocol</SectionLabel>
