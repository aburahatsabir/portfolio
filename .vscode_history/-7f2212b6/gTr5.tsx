        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-16 mb-24">
          <div className="max-w-3xl space-y-6">
            <div className="flex items-center gap-4">
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-600">Enterprise Proof</span>
            ...
            <nav role="tablist" className="inline-flex items-center bg-slate-100/50 p-1 rounded-[1.25rem] border border-slate-200/40">
              {filterOptions.map((filter) => (
                <button
                  ...
                  className={`group relative flex items-center gap-2 px-6 py-2.5 rounded-[1rem] transition-all duration-300 whitespace-nowrap outline-none ${
          ...
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project) => (
              <motion.div 
                ...
                onClick={() => window.location.hash = `#/work/${project.id}`}
              >
