...
const EndorsementCard: React.FC<{ testimonial: any, index: number }> = ({ testimonial, index }) => {
  return (
    <motion.div
      ...
      className="flex-none w-full md:w-[calc(50%-12px)] lg:w-[calc(33.333%-22px)] snap-start"
    >
      <BentoCard rounded="2xl" padding="lg" hoverShadow="lg" className="hover:shadow-[0_40px_80px_-15px_rgba(15,23,42,0.04)]">
