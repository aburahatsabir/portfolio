        ...
        <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 mb-20">
          <div className="max-w-3xl space-y-6">
            <div className="flex items-center gap-4">
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-blue-600">Institutional Proof</span>
          ...
          <div className="flex items-center gap-3 pb-2">
             <button 
               ...
               className={`w-14 h-14 rounded-2xl border flex items-center justify-center transition-all active:scale-90 ${
                 canScrollLeft ? 'border-slate-200 text-slate-900 hover:bg-slate-50' : 'border-slate-100 text-slate-200 cursor-not-allowed'
               }`}
             ...
             <button 
               ...
               className={`w-14 h-14 rounded-2xl border flex items-center justify-center transition-all active:scale-90 ${
                 canScrollRight ? 'border-slate-200 text-slate-900 hover:bg-slate-50' : 'border-slate-100 text-slate-200 cursor-not-allowed'
               }`}
