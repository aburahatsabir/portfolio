...
const OutcomeCard: React.FC<{ story: any; index: number }> = ({ story, index }) => {
  return (
    <motion.div
      ...
      className="group relative h-full flex flex-col bg-white border border-slate-100 rounded-[2.5rem] p-8 md:p-10 hover:border-blue-600/30 hover:shadow-2xl hover:shadow-blue-900/5 transition-all duration-700"
    >
      {/* Client Identity */}
      ...
      <div className="flex-1 space-y-10">
        <div className="space-y-3">
          <h5 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Institutional Friction</h5>
        ...
        <div className="space-y-3">
          <h5 className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-600">Remediation Architecture</h5>
        ...
        <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-16 mb-24">
          <div className="max-w-3xl space-y-6">
            <div className="flex items-center gap-4">
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-600">Performance Records</span>
