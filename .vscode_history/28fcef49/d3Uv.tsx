          ...
          >
            <div className="pt-32 pb-12 px-8 flex flex-col min-h-screen">
              <div className="flex-1 space-y-8">
                <SectionLabel as="p" tracking="wide" className="mb-8">Navigation Menu</SectionLabel>
              ...
              <div className="mt-12 space-y-8">
                ...
                <div className="flex justify-between items-center text-[9px] font-black text-slate-400 uppercase tracking-widest">
                  ...
                  <div className="flex gap-4">
                    <a href="https://linkedin.com/in/aburahatsabir78" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors">LinkedIn</a>
                    <a href="https://github.com/aburahatsabir" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600 transition-colors">GitHub</a>
                  </div>
                </div>
              </div>
            </div>
