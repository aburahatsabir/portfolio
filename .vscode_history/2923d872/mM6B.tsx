    ...
    <div className="py-12 border-y border-slate-100 my-20">
      <div className="flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="space-y-2 text-center md:text-left">
          <SectionLabel as="h4" tracking="normal">Content Efficacy Audit</SectionLabel>
              ...
              >
                <svg
                  className={`w-8 h-8 transition-colors duration-200 ${
                    star <= (hoveredRating || 0) ? 'fill-blue-600 text-blue-600' : 'fill-transparent text-slate-200 stroke-2'
                  }`}
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  stroke="currentColor"
