...
const CapabilityModule: React.FC<{
  ...
  return (
    ...
    >
      <BentoCard rounded="2xl" padding="lg" hoverShadow="lg" className="hover:shadow-[0_40px_80px_-15px_rgba(15,23,42,0.06)]">
        ...
        <div className="px-0 py-8 bg-slate-50/50 flex flex-wrap gap-2.5 group-hover:bg-blue-50/30 transition-all duration-500 border-t border-slate-50">
        {tags.map((tag) => (
          <span 
            key={tag} 
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-16 mb-24">
          <div className="max-w-4xl w-full space-y-8">
            <div className="flex items-center gap-4">
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-600">Core Expertise</span>
