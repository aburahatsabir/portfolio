...
const Hero: React.FC = () => {
  ...
  const content = {
    ...
    efficiency: {
      image: "/images/hero-efficiency.jpg",
      imageSrcSet: "/images/hero-efficiency-sm.jpg 480w, /images/hero-efficiency-md.jpg 1024w, /images/hero-efficiency.jpg 1440w",
            ...
            <div className="space-y-8">
              <motion.div variants={itemVariants} className="flex gap-3">
                <motion.button 
                  ...
                  className={`relative overflow-hidden text-[10px] font-black uppercase tracking-[0.2em] px-7 py-3.5 rounded-xl transition-all border ${
                    activeMandate === 'sovereignty' 
