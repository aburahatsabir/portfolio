  ...
  return (
    <div className="relative pl-20 md:pl-40 pb-16 last:pb-0">
      ...
      */}
      <button 
        onClick={onClick}
        className={`absolute top-1 w-8 h-8 rounded-full border flex items-center justify-center z-10 transition-all duration-500 bg-white group focus:outline-none -translate-x-1/2 ${
          isActive ? 'border-blue-600 shadow-lg shadow-blue-500/10' : 'border-slate-300 hover:border-blue-500'
        }`}
        style={{ left: 'var(--timeline-center)' }}
      >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="max-w-3xl mb-24 space-y-6">
          <div className="flex items-center gap-4">
            <SectionLabel tracking="wide">Professional Record</SectionLabel>
