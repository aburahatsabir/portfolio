        ...
        >
          ...
          <div className="grid lg:grid-cols-[1fr_300px] gap-16 items-center relative z-10 text-center lg:text-left">
            ...
            <div className="flex flex-col gap-4">
              <button type="button" className="px-10 py-5 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-blue-600 transition-all shadow-xl shadow-slate-900/10">
                Request Sample SOP
              </button>
              <button type="button" className="px-10 py-5 bg-white text-slate-500 border border-slate-200 rounded-2xl font-black text-xs uppercase tracking-widest hover:text-blue-600 transition-all">
                View Logic Map Demo
              </button>
            </div>
          </div>
          ...
          <div className="fixed inset-0 z-[400] flex items-center justify-center px-6">
            ...
            >
              <div className="flex justify-between items-start mb-16 border-b border-slate-100 pb-12">
                ...
                <button type="button" onClick={closeModal} className="w-14 h-14 rounded-2xl bg-slate-100 flex items-center justify-center hover:bg-slate-200 transition-all group">
              ...
              <div className="p-12 bg-slate-950 text-white rounded-[4rem] flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden group">
                ...
                <button type="button" className="bg-blue-600 px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl shadow-blue-900/40 relative z-10 whitespace-nowrap active:scale-95">
