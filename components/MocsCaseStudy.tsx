    ...
    return (
        <div className="fmcg-case-study">
            <style>{`
                ...
                .fmcg-case-study .vis-bar { width: 100%; border-radius: 4px 4px 0 0; position: relative; }
                .fmcg-case-study .vis-bar-val { font-family: var(--sans); font-weight: 700; font-size: 14px; color: var(--ink); text-align: center; }
                ...
                .fmcg-case-study .journey-steps::before {
                    content: '';
                    position: absolute;
                    top: 16px;
                    left: 20px;
                ...
                .fmcg-case-study .module-card::before {
                    content: '';
                    position: absolute;
                    top: 0;
                    left: 0;
                ...
                .fmcg-case-study .module-card:hover::before {
                    opacity: 1;
                }
                ...
                .fmcg-case-study .sm-row:hover { background: var(--off2); }
                ...
                .fmcg-case-study .results-band .eyebrow { color: var(--ink3); border-color: var(--ln); }
                .fmcg-case-study .results-band .eyebrow::before { background: var(--ink3); }
                ...
                <div className="max-w-7xl mx-auto px-6 w-full">
                    <div className="hero-inner">
                        <div className="hero-content">
                            <div className="eyebrow fade d1">MOCS v2.0 · CASE STUDY</div>
                            <h1 className="fade d2">
                                Medical Operations<br />Control <em>System</em>
                            </h1>
                            <p className="lead fade d3">
                                How Cikitsa India rebuilt its entire patient coordination infrastructure — from fragmented spreadsheets to a unified, real-time operations platform managing 2,000+ patient journeys annually.
                            </p>
                            ...
                            <div className="fade d4 mt-10 flex gap-4">
                                <a href="#demo" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                                    View Live Demo
                                </a>
                                <a href="#system" className="inline-flex items-center justify-center px-6 py-3 border border-slate-200 text-sm font-medium rounded-md text-slate-700 bg-white hover:bg-slate-50">
                                    Explore System &rarr;
                                </a>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6 w-full">
                    <div className="wide fade">
                        ...
                        <div className="two-col">
                            <div>
                                <h2>Medical tourism from Bangladesh to India is a <em>coordination problem</em></h2>
                                ...
                                <p className="body-copy">Cikitsa India acts as the patient-side operations bridge — not a hospital, not a travel agency, but a specialist coordination layer between Bangladeshi patients (and their local travel agents) and the Indian healthcare system.</p>
                                ...
                                <div className="context-quote">
                                    "A patient's visa approval status was stored in a chat message from six weeks ago. A follow-up call went to the wrong number. The treatment happened, and nobody from our side knew."
                            ...
                            <div className="vis-chart-wrap">
                                ...
                                <div className="vis-bars">
                                    <div className="vis-bar-group">
                                        ...
                                        <div className="vis-bar" style={{ height: 34, background: 'var(--off2)' }}></div>
                                    ...
                                    <div className="vis-bar-group">
                                        <div className="vis-bar-val" style={{ color: 'var(--brand)' }}>2,110+</div>
                            ...
                            <div className="journey-services fade d3">
                                <div className="js-card">
                                    ...
                                    <div className="js-list">
                                        ...
                                        <div>🗣️ Expert Advisory Call</div>
                                    </div>
                                </div>
                                <div className="js-card">
                                    ...
                                    <div className="js-list">
                                        ...
                                        <div>🗺️ Local City Guide (Non-medical)</div>
                ...
                <div className="max-w-7xl mx-auto px-6 w-full">
                    <div className="wide fade">
                        ...
                        <div className="service-matrix fade d2">
                            ...
                            <div className="sm-row">
                                <div className="sm-service">Airport Pickup</div>
                                <div className="sm-val"><span className="sm-check">✓</span><span className="sm-price">৳199</span></div>
                                <div className="sm-val"><span className="sm-check">✓</span><span className="sm-price">৳199</span></div>
                                <div className="sm-val"><span className="sm-check">✓</span><span className="sm-price">৳199</span></div>
                                <div className="sm-val"><span className="sm-check">✓</span><span className="sm-price">৳199</span></div>
                            </div>
                            <div className="sm-row">
                                <div className="sm-service">OP Commission (CI)</div>
                                <div className="sm-val"><span className="sm-price">5%</span></div>
                                <div className="sm-val"><span className="sm-price">19%</span></div>
                                <div className="sm-val"><span className="sm-price">18%</span></div>
                                <div className="sm-val"><span className="sm-price">20%</span></div>
                            </div>
                            <div className="sm-row">
                                <div className="sm-service">IP Commission (CI)</div>
                                <div className="sm-val"><span className="sm-price">5%</span></div>
                                <div className="sm-val"><span className="sm-price">19%</span></div>
                                <div className="sm-val"><span className="sm-price">18%</span></div>
                                <div className="sm-val"><span className="sm-price">20%</span></div>
                            ...
                            <div className="sm-row">
                                <div className="sm-service">Liver Transplant</div>
                                <div className="sm-val"><span className="sm-check">✓</span><span className="sm-price" style={{ fontSize: 10 }}>23–27L INR</span></div>
                                <div className="sm-val"><span className="sm-check">✓</span><span className="sm-price" style={{ fontSize: 10 }}>23–27L INR</span></div>
                                <div className="sm-val"><span style={{ color: 'var(--ink4)' }}>—</span></div>
                                <div className="sm-val"><span className="sm-check">✓</span><span className="sm-price" style={{ fontSize: 10 }}>23–27L INR</span></div>
                            </div>
                            <div className="sm-row">
                                <div className="sm-service">IVF Program</div>
                                <div className="sm-val"><span style={{ color: 'var(--ink4)' }}>—</span></div>
                                <div className="sm-val"><span style={{ color: 'var(--ink4)' }}>—</span></div>
                                <div className="sm-val"><span style={{ color: 'var(--ink4)' }}>—</span></div>
                                <div className="sm-val"><span style={{ color: 'var(--ink4)' }}>—</span></div>
            ...
            {/* INTERACTIVE SYSTEM */}
            <section id="interactive" className="alt">
                <div className="max-w-7xl mx-auto px-6 w-full">
                    <div className="wide fade in">
                        <div className="eyebrow">07 · Interactive System</div>
                        <h2>The <em>MOCS interface</em>, live</h2>
                        <p className="body-copy" style={{ maxWidth: 580 }}>A fully functional simulation of the Medical Operations Control System — explore patient tracking, visa pipeline, finance engine, and hospital network with real data from the operations.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="results" className="results-band">
                <div className="max-w-7xl mx-auto px-6 w-full">
                    <div className="eyebrow fade">08 · Results</div>
                    
                    <div className="two-col mt-4">
                        <div className="fade d1">
                            <h2>Operational impact<br/>across <em>every metric</em></h2>
                            <p className="body-copy" style={{ color: 'var(--ink3)', maxWidth: 440 }}>From coordination chaos to systematic control — MOCS delivered measurable improvements across patient throughput, visa success rates, team efficiency, and revenue capture.</p>
                        </div>
                        
                        <div className="flex flex-col gap-3 justify-center fade d2">
                            <div style={{ background: 'var(--w)', border: '1px solid var(--ln)', borderRadius: '10px', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: '14px', transition: 'background .2s' }} onMouseEnter={(e) => (e.currentTarget.style.background = 'var(--off2)')} onMouseLeave={(e) => (e.currentTarget.style.background = 'var(--w)')}>
                                <div style={{ fontSize: 28 }}>📈</div>
                                <div>
                                    <div style={{ fontSize: 15, fontWeight: 600, color: 'var(--ink)', marginBottom: 2 }}>340% case volume growth</div>
                                    <div style={{ fontSize: 12, color: 'var(--ink3)' }}>Without proportional headcount increase</div>
                                </div>
                            </div>
                            ...
                            <div style={{ background: 'var(--w)', border: '1px solid var(--ln)', borderRadius: '10px', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: '14px', transition: 'background .2s' }} onMouseEnter={(e) => (e.currentTarget.style.background = 'var(--off2)')} onMouseLeave={(e) => (e.currentTarget.style.background = 'var(--w)')}>
                                <div style={{ fontSize: 28 }}>🎯</div>
                                <div>
                                    <div style={{ fontSize: 15, fontWeight: 600, color: 'var(--ink)', marginBottom: 2 }}>Zero rate-quoting errors</div>
                                    <div style={{ fontSize: 12, color: 'var(--ink3)' }}>Centralized rate matrix eliminates discrepancies</div>
                                </div>
                            </div>
                            ...
                            <div style={{ background: 'var(--w)', border: '1px solid var(--ln)', borderRadius: '10px', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: '14px', transition: 'background .2s' }} onMouseEnter={(e) => (e.currentTarget.style.background = 'var(--off2)')} onMouseLeave={(e) => (e.currentTarget.style.background = 'var(--w)')}>
                                <div style={{ fontSize: 28 }}>⚡</div>
                                <div>
                                    <div style={{ fontSize: 15, fontWeight: 600, color: 'var(--ink)', marginBottom: 2 }}>&lt; 1 day coordinator onboarding</div>
                                    <div style={{ fontSize: 12, color: 'var(--ink3)' }}>From 3–4 weeks with spreadsheet-based ops</div>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div className="results-grid fade d3">
                        <div className="result-cell">
                            <div className="result-num">2,110<span>+</span></div>
                            <div className="result-label">Patients tracked across all years in the system</div>
                            <div className="result-note">↑ from ~600 in 2022</div>
                        </div>
                        <div className="result-cell">
                            <div className="result-num">97<span>%</span></div>
                            <div className="result-label">Visa success rate for patients with full documentation</div>
                            <div className="result-note">vs. ~78% pre-MOCS</div>
                        </div>
                        <div className="result-cell">
                            <div className="result-num">30<span>+</span></div>
                            <div className="result-label">Partner hospital cities with encoded rate data</div>
                            <div className="result-note">7 chains · 14 facilities</div>
                        </div>
                        <div className="result-cell">
                            <div className="result-num">0</div>
                            <div className="result-label">Commission reconciliation disputes since system launch</div>
                            <div className="result-note">down from 4–6/month</div>
                        </div>
                    </div>
                </div>
            </section>
