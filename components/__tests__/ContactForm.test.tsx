...
describe('ContactForm', () => {
    ...
    it('submits form with valid data', async () => {
        ...
        await user.type(screen.getByPlaceholderText(/message/i), 'This is a test message with enough content to pass validation.');
    ...
    it('shows success message after submission', async () => {
        ...
        await user.type(screen.getByPlaceholderText(/message/i), 'Test message content here');
